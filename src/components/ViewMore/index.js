...
const ViewMore = () => {
	return (
		<ViewMoreListedWrapper>
			<div className='container-fluid'>
				<div className='ViewMore_list_wrapper my-5'>
					<div className='container my-4'>
						<h2 id='header'>Recently Listed</h2>
					</div>
...
const ViewMoreListedWrapper = /*css*/ styled.div`
	height: 100vh;
	.ViewMore_list_wrapper {
		margin-bottom: 5rem;
